...
/**
 * check97 - fucntion that checks for the correct number of arguments
...
/**
 * check98 - function that checks that file_from exists and can be read
...
/**
 * check99 - function tha checks that file_to was created and/or can be written to
