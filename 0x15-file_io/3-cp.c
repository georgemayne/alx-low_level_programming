...
/**
 * check97 - function that checks for the
...
/**
 * check98 - function that checks that file_from
 * exists and can be read
 * @check: check
 * @file: file name
 * @fd_from: file_from, or -1
 * @fd_to: file_to, or -1
 * Return: void
 */
...
/**
 * check100 - function that checks that file descriptors
